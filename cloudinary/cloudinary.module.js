...
exports.CloudinaryModule = CloudinaryModule = __decorate([
    (0, common_1.Module)({
        providers: [constants_1.CloudinaryProvider, cloudinary_service_1.CloudinaryService],
        exports: [constants_1.CloudinaryProvider, cloudinary_service_1.CloudinaryService]
    })
], CloudinaryModule);
